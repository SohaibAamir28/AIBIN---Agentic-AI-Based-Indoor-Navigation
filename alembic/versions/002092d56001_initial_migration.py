...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('DRAFT', 'ACTIVE', 'ARCHIVED', 'OUT_OF_STOCK', name='Projectstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_Projects_sku'), 'Projects', ['sku'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_Projects_sku'), table_name='Projects')
