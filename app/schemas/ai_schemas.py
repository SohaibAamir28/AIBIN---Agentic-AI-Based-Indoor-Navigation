...
class ProductRecommendationRequest(AIRequest):
    ...
    exclude_Projects: Optional[List[UUID]] = Field(default=None, description="Projects to exclude")
...
class ProductRecommendationResponse(AIResponse):
    ...
    total_Projects_considered: int = Field(..., description="Total Projects considered")
