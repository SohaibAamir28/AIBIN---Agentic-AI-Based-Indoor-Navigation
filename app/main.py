"""
AIBIN | Agentic AI Based Indoor Navigation FastAPI Application
...
from app.api import auth, users, Projects, category, ai_routes
...
app = FastAPI(
    ...
    description="AI-powered Indoor Navigation platform with voice interface and intelligent product recommendations using Groq API",
    version=settings.APP_VERSION,
...
app.include_router(Projects.router, prefix=f"{settings.API_V1_PREFIX}")
...
async def root():
    ...
    return {
        ...
        "description": "AI-powered Indoor Navigation platform with voice interface",
        "version": settings.APP_VERSION,
