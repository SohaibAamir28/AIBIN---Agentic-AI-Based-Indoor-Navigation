"""
Structured JSON logging utility for AIBIN application.
...
class AIBINLogger:
    """AIBIN centralized logging utility."""
    
    def __init__(
        self,
        logger_name: str = "AIBIN",
        log_level: str = "INFO",
        log_dir: str = "logs",
...
def get_logger(name: str = None) -> logging.Logger:
    ...
    if name:
        return logging.getLogger(f"AIBIN.{name}")
    return logger
