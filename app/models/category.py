"""
Category model for AIBIN Indoor Navigation platform.
...
class Category(BaseModel):
    """
    Category model for organizing Projects hierarchically.
    ...
    Projects = relationship("Product", back_populates="category")
