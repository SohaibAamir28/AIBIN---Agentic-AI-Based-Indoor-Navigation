"""
Product model for AIBIN Indoor Navigation platform.
...
class Product(BaseModel):
    """
    Product model for the Indoor Navigation platform.
    
    Stores all core product information, pricing, and inventory data.
    Supports both new and second-hand Projects.
    """
    ...
    def is_in_stock(self) -> bool:
        ...
        return self.quantity > 0 and self.status == Projectstatus.ACTIVE
