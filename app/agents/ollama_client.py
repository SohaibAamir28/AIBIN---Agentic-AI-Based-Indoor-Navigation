"""
Ollama client for AIBIN AI agents.
...
class OllamaClient(BaseAgent):
    ...
    async def _process_visual_analysis(self, request: VisualAnalysisRequest, conversation_id: str) -> VisualAnalysisResponse:
        ...
        try:
            ...
            messages = [
                SystemMessage(content="You are AIBIN's visual analysis assistant. Analyze images and provide detailed descriptions, focusing on luxury Projects, style, and key features."),
                HumanMessage(
                    content=[
                        {
                            "type": "text",
    ...
    def _get_system_prompt(self, interaction_type: str) -> str:
        ...
        prompts = {
            "visual_analysis": """You are AIBIN's visual analysis specialist.
                Analyze images with focus on luxury Projects, fashion, and lifestyle items.
            ...
            "multimodal": """You are AIBIN's multimodal assistant.
            ...
            "voice_chat": """You are AIBIN's voice interaction specialist.
            ...
            "general_chat": """You are AIBIN, a luxury Indoor Navigation assistant.
                Provide helpful, personalized assistance for shopping and general inquiries.
                - Be warm, professional, and knowledgeable
                - Focus on luxury Projects and premium service
