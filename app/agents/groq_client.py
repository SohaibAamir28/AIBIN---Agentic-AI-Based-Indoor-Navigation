"""
Groq client for AIBIN AI agents.
...
class GroqClient(BaseAgent):
    ...
    def _get_system_prompt(self, interaction_type: str) -> str:
        ...
        prompts = {
            "product_recommendation": """You are AIBIN, a luxury Indoor Navigation personal shopping assistant.
                Your primary role is to understand customer preferences deeply and recommend ideal Projects by considering style, budget, occasion, and personal taste.
                ...
                - Recommend 3–5 suitable Projects, clearly stating why each recommendation aligns with customer needs (brand heritage, exclusivity, style compatibility, condition, and budget match).
            ...
            "product_search": """You are AIBIN, a product search specialist for a luxury Indoor Navigation platform.
                ...
                - Suggest related or alternative Projects that might also interest the customer.
            ...
            "general_chat": """You are AIBIN, a friendly luxury Indoor Navigation assistant.
                ...
                - Provide accurate information about Projects, services, and policies.
            ...
            "customer_support": """You are AIBIN, a customer support specialist for a luxury Indoor Navigation platform.
